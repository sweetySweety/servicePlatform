...
export default {
        ...
        onChange: (selectedRowKeys, selectedRows) => {
          ...
          for(let i = 0; i<selectedRowKeys.length; i++){
            this.deleteList[i] = {
              ...
              role:this.propscurrent.userRole,
 ...
 mounted(){
      ...
      this.getProjects()
      this.getAllSys()
      this.getUserDetail(this.propscurrent.userRole,this.propscurrent.userName,"current")
 },
  methods: {
    goTo(){
    ...
    deleteByIds(){
      ...
      let response = (res) => {
        ...
        this.selectPeopleDetailBy(this.propscurrent.userRole,this.propscurrent.userId,this.propscurrent.userName,this.govPerson,this.devPerson,this.soId,this.stage,this.provider,"current")
      }
