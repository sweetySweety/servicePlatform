  ...
  <div>
    ...
    <ul class="flex">
      ...
      <li class="flex">
        ...
        <a-select defaultValue=""
          ...
          <a-select-option value="http"
                           :key="3">http</a-select-option>
          <a-select-option value="post"
                           :key="4">post</a-select-option>
        </a-select>
      ...
      <a-button icon="search"
                ...
                type="primary"
                @click="searchSystemList">查询</a-button>
      <a-button icon="search"
                style="margin-right:10px;"
                type="primary"
                @click="emptyIpt">清空</a-button>
    </ul>

    <div class="title"
         style="margin-top:20px;">系统基本信息维护</div>

    <div style="margin-bottom:20px">
      <a-button icon="edit"
                style="margin-right:10px;"
                @click="showAddModel">新增</a-button>
      <a-button icon="edit"
                style="margin-right:10px;"
                :disabled="isChange"
                @click="showEditModel">修改</a-button>
      <a-button icon="delete"
                style="margin-right:10px;"
                :disabled="isChange"
                @click="showConfirm">删除</a-button>
      <a-button icon="file"
                style="margin-right:10px;"
                @click="goFileManage">文件管理</a-button>
      <a-button icon="file"
                style="margin-right:10px;"
                @click="goNewspaper">报文头管理</a-button>
      <a-button icon="file"
                style="margin-right:10px;"
                @click="goSystemInfoList">系统详细信息管理</a-button>
      <a-button icon="file"
                style="margin-right:10px;"
                @click="goAgreementManage">协议管理</a-button>
    </div>
    <div>
    ...
    <a-modal :title="title"
      ...
      <div class="graybox">
        <ul>
          ...
          <li class="flex"
              style="margin-bottom:10px;">
            <font class="iptTitle">系统中文名称：</font>
            <a-input placeholder=""
                     style="width:250px ;margin-left:10px;"
                     v-model="asystemChineseName" />
          </li>
          <li class="flex"
              style="margin-bottom:10px;">
            <font class="iptTitle">系统详细信息：</font>
            <a-select defaultValue=""
                      style="width:250px ;margin-left:10px;"
                      v-model="asystemInfomation">
